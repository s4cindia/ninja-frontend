...
- **Merged Detection + Validation**: Upload page supports optional style selection (APA 7th, MLA 9th, Chicago 17th, Vancouver, IEEE). When a style is selected, detection automatically runs validation and returns combined results. Validation summary banner appears on the Citations tab with error/warning counts and a link to the full Validation tab.
